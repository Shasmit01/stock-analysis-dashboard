...
app.layout = html.Div([
    html.Div([
        html.H1("Stock Portfolio Dashboard [DEMO MODE]", style={'textAlign': 'center', 'marginBottom': 10}),
        html.P("Using sample data to demonstrate dashboard functionality",
               style={'textAlign': 'center', 'color': '#ff6b6b', 'fontSize': '14px', 'marginBottom': 10}),
...
if __name__ == '__main__':
    print("\n" + "="*50)
    print("Starting Dashboard (DEMO MODE WITH SAMPLE DATA)...")
